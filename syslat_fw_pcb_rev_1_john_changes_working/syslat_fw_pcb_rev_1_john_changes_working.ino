...
const int timerTimeout = 500;
//const int timerTimeout = 5000;
...
void loop() {
  while (timeoutCounter < 3) {
    ...
    //if (i < timerTimeout) { // Why are we using i here instead of timerTotal? Seems odd... not sure why I did that.
